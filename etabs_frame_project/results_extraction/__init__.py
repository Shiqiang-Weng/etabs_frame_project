...
from common.config import SCRIPT_DIRECTORY, DATA_EXTRACTION_DIR, ANALYSIS_DATA_DIR, DESIGN_DATA_DIR
...
def extract_all_analysis_results(
    ...
    output_directory = Path(output_dir) if output_dir is not None else Path(ANALYSIS_DATA_DIR)
